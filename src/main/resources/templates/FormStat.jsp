                    ...
                    <div class="content-wrapper">
                        <div class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <sf:form class="forms-sample" method="POST" modelAttribute="Statistique" action="/backoffice/getStat">
                                            ...
                                            <div class="form-group">
                                                <select name="idType" class="form-control" id="" <sf:input path="IdType"/> >
                                            ...
                                            <div class="form-group">
                                                <select name="idStatus" class="form-control" id="" <sf:input path="IdStatus"/> >
                                            ...
                                            <div class="form-group">
                                                <input type="checkbox" class="form-check-input" id="scales" name="valide"
                                                       checked>
                                                <label for="scales">Ajouter des filtres par dates</label>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputConfirmPassword1">Date debut</label>
                                                <input type="date" class="form-control" id="start" name="DateDeb"
                                                       value=""
                                                       min="" max="" >
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputConfirmPassword1">Date fin</label>
                                                <input type="date" class="form-control" id="start" name="DateFin"
                                                       value=""
                                                       min="" max="">
                                            </div>
                            ...
                            <div class="col-lg-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Statistique globale par Type</h4>
                            ...
                            <div class="col-lg-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Statistique globale Region</h4>
                            ...
                            <div class="col-lg-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Statistique globale par Status</h4>
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.ListStatStatus}" var="lists">
                                                        <tr>
                                                            <td>
                                                                ${ListStatus.get(lists.getId()-1).getNomStatus()}
                                                            </td>

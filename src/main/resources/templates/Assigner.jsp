...
<html lang="en">
    ...
    <head>
        ...
        <title>Assignement region</title>
        <!-- plugins:css -->
                    ...
                    <div class="content-wrapper">
                        <div class="row">
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Assignement region</h4>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.ListSign}" var="lists">
                                                        <tr>
                                                            <td>
                                                                ${ListType.get(lists.getIdType()-1).getNomType()}
                                                            </td>
                                                            <td>
                                                                ${ListStatus.get(lists.getIdStatus()-1).getNomStatus()}
                                                            </td>
                                                            <td>
                                                                ${lists.getDateHeureSignalement()}
                                                            </td>
                                                            <td>
                                                                <a href="/backoffice/Assign?Long=${lists.getLongitude()}&Lat=${lists.getLatitude()}&Id=${lists.getIdSignalement()}">assigner une region</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>

                    ...
                    <div class="content-wrapper">
                        <div class="row">
                            ...
                            <div class="col-md-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Assignement</h4><!--signalementregion-->
                                        <form method="POST" modelAttribute="SignalementRegion" action="/backoffice/insertSign">
                                            <input name="IdSignalement" type="hidden"  class="form-control" value="${Signalement.getIdSignalement()}">
                                            <div class="form-group">
                                                <label for="">Nom de Region trouve grace aux coordonees :</label>
                                                <input name="NomRegion" type="text" class="form-control" value="${region}" style="border:none;background:transparent" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Type :</label>
                                                <input name="NomType" type="text" class="form-control" value="${ListType.get(Signalement.getIdType()-1).getNomType()}" style="border:none;background:transparent" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Status :</label>
                                                <input name="NomStatus" type="text" class="form-control" value="${ListStatus.get(Signalement.getIdStatus()-1).getNomStatus()}" style="border:none;background:transparent" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="">Date de Signalement :</label>
                                                <input name="DateHeureSignalement" type="text" class="form-control" value="${Signalement.getDateHeureSignalement()}" style="border:none;background:transparent" readonly>
                                            </div>

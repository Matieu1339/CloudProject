...
<html lang="en">
    ...
    <head>
        ...
        <title>Modification Responsable Region</title>
        <!-- plugins:css -->
                    ...
                    <div class="content-wrapper">
                        <div class="row">
                            ...
                            <div class="col-md-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Insertion Responsable Region</h4>
                                        <p class="card-description">
                                            Basic form layout
                                        </p>
                                        <sf:form method="POST" modelAttribute="ResponsableRegion" action="/backoffice/insertResp">
                                            <fieldset>
                                                <form class="forms-sample">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <sf:input path="MotDePasse" class="form-control" placeholder="MotDePasse"/>

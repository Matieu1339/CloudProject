                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody style="width:50px">
                                                    <c:forEach items="${requestScope.listRespReg}" var="respReg">
                                                        <sf:form method="POST" modelAttribute="ResponsableRegion" action="/backoffice/UpdateRespReg">
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <sf:form method="POST" modelAttribute="ResponsableRegion" action="/backoffice/DeleteRespReg">
                                                                        <sf:input path="IdResponsable" name="IdResponsable" type="hidden" value="${respReg.getIdResponsable()}"/>

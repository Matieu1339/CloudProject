                    ...
                    <div class="content-wrapper">
                        <div class="row">
                            ...
                            <div class="col-md-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Insertion Utilisateur</h4>
                                        <p class="card-description">
                                            Basic form layout
                                        </p>
                                        <sf:form method="POST" modelAttribute="Utilisateur" action="/backoffice/insertUser">
                                            <fieldset>
                                                <form class="forms-sample">
                                                    <div class="form-group">
                                                        <label for="Nom">Nom</label>
                                                        <sf:input path="Nom" class="form-control" placeholder="Nom"/>
                                                        <sf:errors path="Nom" class="form-control"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Prenom">Prenom</label>
                                                        <sf:input path="Prenom" class="form-control" placeholder="Prenom"/>
                                                        <sf:errors path="Prenom" class="form-control"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Date de naissance">Date de Naissance</label>
                                                        <sf:input type="date" path="DateNaissance" class="form-control"/>
                                                        <sf:errors path="DateNaissance" class="form-control"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Email">Email</label>
                                                        <sf:input path="Email" class="form-control" placeholder="Email@gmail.com"/>
                                                        <sf:errors path="Email" class="form-control"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="MotDePasse">Mot de passe</label>
                                                        <sf:input path="MotDePasse" class="form-control" placeholder="Mot De Passe"/>
                                                        <sf:errors path="MotDePasse" class="form-control"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Sexe">Sexe</label>
                                                        <sf:input path="Sexe" class="form-control" placeholder="Sexe"/>
                                                        <sf:errors path="Sexe" class="form-control"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Contact">Contact</label>
                                                        <sf:input path="Contact" class="form-control"/>
                                                        <sf:errors path="Contact" class="form-control"/>
                                                    </div>
                                                    <button type="submit" class="btn btn-primary me-2">Valider</button>
                                                    <button class="btn btn-light" onclick="window.location.href='/'">Annuler</button>
                                                </form>
                                            </fieldset>
                                        </sf:form>

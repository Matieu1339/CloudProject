                            ...
                            <div class="col-md-6 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <sf:form method="POST" modelAttribute="Statistique" action="/backoffice/find">
                                            <form class="forms-sample">
                                                ...
                                                <div class="form-group row">
                                                    <label for="start" class="col-sm-3 col-form-label">Date debut:</label>
                                                    <div class="col-sm-9">
                                                ...
                                                <div class="form-group row">
                                                    <label for="start" class="col-sm-3 col-form-label">Date fin:</label>
                                                    <div class="col-sm-9">
                                                ...
                                                <button class="btn btn-light" onclick="window.location.href = '/backoffice/FormSearch'">Cancel</button>
                                            </form>
                                        </sf:form>
                                    </div>
                                </div>
